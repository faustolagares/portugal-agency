    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="rb-12 mb-12 max-w-lg md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Pronto</p>
          <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Entre em contato
          </h2>
          <p className="md:text-md">
            Nosso time está disponível para responder suas perguntas e ajudar.
          </p>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 md:grid-cols-[0.5fr_1fr] md:gap-x-20 md:gap-y-16">
          <div className="grid auto-cols-fr grid-cols-1 gap-x-4 gap-y-10">
            <div>
              ...
              <p className="mb-2">Envie sua mensagem</p>
            ...
            <div>
              ...
              <p className="mb-2">Ligue para falar conosco</p>
              <a className="underline" href="#">
                +1 (201) 555-0100
              </a>
            </div>
            <div>
              ...
              <p className="mb-2">Visite nosso escritório em New Jersey</p>
