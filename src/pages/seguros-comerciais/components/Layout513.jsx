        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:items-start md:gap-20">
          <div className="flex flex-col gap-y-16 md:sticky md:top-20 md:mt-20 md:h-[calc(100vh_-10rem)] md:justify-center">
            <div className="flex flex-col">
              <p className="mb-3 font-semibold md:mb-4">Cobertura</p>
              <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Seguros para cada tipo de negócio
              </h2>
              <p className="md:text-md">
                Proteja sua empresa com as coberturas certas. Desde startups até
                operações estabelecidas, temos o seguro adequado para você.
              </p>
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      ...
                      <p>
                        Cobertura contra danos corporais e materiais causados
                        por suas operações
                      </p>
                      <div className="mt-4">
                        <img
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      ...
                      <p>
                        Combinação de propriedade e responsabilidade em um único
                        pacote para proprietários comerciais
                      </p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-3.svg"
